    ...
    return res
      ...
      .json(
        new ApiResponse(
          202,
          null,
          "Smart Summary generation already in progress"
        )
      );
  }
    ...
    return res
      ...
      .json(
        new ApiResponse(
          202,
          null,
          "Short Notes generation already in progress"
        )
      );
  }
    ...
    return res
      ...
      .json(
        new ApiResponse(
          202,
          null,
          "MindMap generation already in progress"
        )
      );
  }
