...
const LOADER_MESSAGES = [
  "📚 Analyzing board exam pattern…",
  "⏳ Identifying most scoring points…",
  "✍️ Structuring answer like a topper…",
  "🎯 Adding keywords examiners expect…",
  "✨ Finalizing exam-ready format…"
];

const TopperLoader = ({ stepLabel = "Loading...", showLoader = true }) => {
