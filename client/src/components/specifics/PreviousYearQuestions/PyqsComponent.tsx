                        ...
                        <div className="space-y-3">
                          <div className="flex flex-wrap gap-2">
                            <button
                              ...
                              className={`flex-1 sm:flex-initial sm:w-auto inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 sm:py-2 bg-gradient-to-r ${getMarksGradient(marks)} text-white rounded-lg font-semibold text-sm hover:opacity-90 transition-opacity shadow-sm`}
                            >
                              {showAnswers[key] ? (
                                <>
